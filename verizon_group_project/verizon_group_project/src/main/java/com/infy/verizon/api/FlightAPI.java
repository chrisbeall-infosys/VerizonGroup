...
public class FlightAPI {
	...
	public ResponseEntity<String> addProductToDeals(@RequestBody Flight flight) throws Exception{
	...
	public ResponseEntity<String> deleteProductFromDeals(@RequestBody String flightId) throws Exception{
